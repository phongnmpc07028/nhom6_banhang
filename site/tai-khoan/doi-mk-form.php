...
<div class="card mx-auto" style="max-width: 380px; margin-top:100px;">
    <div class="card-body">
        ...
        <form action="<?= $SITE_URL ?>/tai-khoan/doi-mkhau.php" method="POST" id="form_doi_mk">
            ...
            <div class="form-group">
                ...
                <input name="mat_khau2" class="form-control" placeholder="Mật khẩu mới" type="password" id="mat_khau2">
            </div> <!-- form-group// -->

            <div class="form-group">
                <label for="password" class="form-label">Xác nhân mật khẩu mới</label>
                <input name="mat_khau3" class="form-control" placeholder="Xác nhân mật khẩu mới" type="password">
            </div> <!-- form-group// -->

            <i class=" text-danger"><?= (isset($MESSAGE) && (strlen($MESSAGE) > 0)) ? $MESSAGE : "" ?></i>

            <div class="form-group">
                <button  type="submit" name="btn_change" class="btn btn-success btn-block"> Đổi mật khẩu </button>
            </div> <!-- form-group// -->
        </form>
