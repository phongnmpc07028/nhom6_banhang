<div class="container">
    ...
    <h4 class="card-header text-center bg-success text-white text-uppercase">Danh sách hàng hóa</h4>
    <?php
            ...
            <form action="?btn_delete_all" method="post" class="table-responsive">
                ...
                <table width="100%" class="table table-hover table-bordered text-center">
                    <thead class="thead-dark">
                        <tr>
                            <th> <input class="form-check-input" type="checkbox" id="select-all" onclick="toggleAllCheckboxes()"></th>
                            <th>Mã HH</th>
                            <th>Tên hàng hóa</th>
                            <th>Ảnh</th>
                            <th>Đơn giá</th>
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><input type="checkbox" class="form-check-input" name="ma_hh[]" value="<?= $ma_hh ?>"></td>
                            <td><?= $ma_hh ?></td>
                            <td><?= $ten_hh ?></td>
                            <td><?= $img ?></td>
                            ...
                            <td class="text-cnter">
                                <a href="<?= $suahh ?>" class="btn btn-outline-success btn-rounded">Sửa</a>
