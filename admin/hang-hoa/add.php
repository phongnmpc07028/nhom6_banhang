<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header text-center bg-success text-white text-uppercase">Thêm mới hàng hóa</div>
            <div class="card-body">
                <form action="index.php" method="POST" enctype="multipart/form-data" id="add_hang_hoa">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="number" name="giam_gia" id="giam_gia" class="form-control" required>
                        </div>
                    </div>
                    <div class="row">
